...
public class OrderEntity {
    ...
    public OrderEntity(String uuid, BigDecimal bill, CouponEntity couponEntity, BigDecimal discount, ZonedDateTime orderDate, PaymentEntity paymentEntity, CustomerEntity customerEntity, AddressEntity addressEntity, RestaurantEntity restaurantEntity) {
        this.uuid = uuid;
        this.bill = bill;
